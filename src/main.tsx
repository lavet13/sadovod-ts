    ...
    components: {
      ...
      MuiButton: {
        variants: [
          ...
          },
          {
            ...
            style: ({ theme }) =>
              theme.unstable_sx({
                ...
                [breakpoints.down('md')]: {
                  fontSize: 'clamp(0.9rem, 1.2vw + 0.5rem, 1.1rem)',
                  px: pxToRem(25),
                  py: pxToRem(10),
                },
                [breakpoints.down('sm')]: {
                  fontSize: 'clamp(0.7rem, 0.6vw + 0.7rem, 0.9rem)',
                  px: pxToRem(30),
                },
              }),
          },
          ...
          {
            props: { variant: 'round-btn', color: 'primary' },
            style: ({ theme }) =>
              theme.unstable_sx({
                ':hover,:active': {
                  backgroundColor: palette.primary.main,
          ...
          {
            props: { variant: 'round-btn', color: 'error' },
            style: ({ theme }) =>
              theme.unstable_sx({
                ':hover,:active': {
