...
const images = [
  {
    ...
    title:
      'Поможем купить и доставить за 7-14 дней с оптово-розничных рынков Москвы в ЛДНР и Крым, а также по всей РФ. <br/><br/>Возможна доставка до двери (только в ЛДНР)',
  },
  {
    id: 2,
